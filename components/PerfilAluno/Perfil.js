      ...
      <Section>
        <Columns>
          <Column>
            ...
            <Content>
              <p>
                <strong>Nome Completo: </strong> Fulano de Tal da Silva
                <br />
                <strong>Idade: </strong> 27 anos
                <br />
                <strong>Endereço: </strong> Rua de Tal, nº 26, Campos do
                Jordão-SP 12460-000
              </p>
            </Content>
          </Column>
          <Column>
            ...
            <Content>
              <p>
                <strong>Data de Vencimento: </strong> 10
                <br />
      ...
      <Section>
        <Columns>
          ...
          <Column>
            ...
            <Content>
              <p>
                <strong>facebook: </strong> fb.com/fulanadetal
                <br />
