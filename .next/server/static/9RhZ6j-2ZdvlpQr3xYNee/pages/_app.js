...
// CONCATENATED MODULE: ./components/AppContainer/Header.js
...
function Header({
  ...
  return __jsx(external_bloomer_["Navbar"], null, __jsx(external_bloomer_["Container"], null, __jsx(external_bloomer_["NavbarBrand"], null, __jsx(external_bloomer_["NavbarItem"], null, __jsx(external_bloomer_["Image"], {
    isSize: "24x24",
    src: "/static/img/logo.png"
  })), __jsx(external_bloomer_["NavbarItem"], {
    style: {
      fontWeight: 300
    }
  }, "Gym App")), __jsx(external_bloomer_["NavbarMenu"], null, __jsx(external_bloomer_["NavbarEnd"], null, __jsx(external_bloomer_["NavbarItem"], null, __jsx(external_bloomer_["Button"], {
    isOutlined: true,
    isColor: "primary",
...
// CONCATENATED MODULE: ./components/AppContainer/routes.js
const routes = {
  geral: [{
    path: '/',
    name: 'Dashboard',
...
// CONCATENATED MODULE: ./components/AppContainer/Sidebar.js
    ...
    return route.map(({
      ...
      if (isActive(path)) {
        ...
        return Sidebar_jsx(link_default.a, {
          href: path,
          key: key
        }, Sidebar_jsx("a", null, name));
      }
    });
  }

  return Sidebar_jsx(external_bloomer_["Menu"], null, Sidebar_jsx(external_bloomer_["MenuLabel"], null, "Geral"), Sidebar_jsx(external_bloomer_["MenuList"], null, mapRoutes(geral)), Sidebar_jsx(external_bloomer_["MenuLabel"], null, "Administra\xE7\xE3o"), Sidebar_jsx(external_bloomer_["MenuList"], null, mapRoutes(admin)), Sidebar_jsx(external_bloomer_["MenuLabel"], null, "Configura\xE7\xF5es"), Sidebar_jsx(external_bloomer_["MenuList"], null, mapRoutes(config)));
}
// EXTERNAL MODULE: ./utils/auth.js
var auth = __webpack_require__("SMlj");

// CONCATENATED MODULE: ./components/AppContainer/index.js

var AppContainer_jsx = external_react_default.a.createElement;
...
function AppContainer({
  ...
  return AppContainer_jsx(external_react_default.a.Fragment, null, AppContainer_jsx(Header, {
    handleLogout: () => Object(auth["b" /* logout */])()
  }), AppContainer_jsx(external_bloomer_["Container"], {
    style: {
      marginTop: 15
    }
  }, AppContainer_jsx(external_bloomer_["Columns"], null, AppContainer_jsx(external_bloomer_["Column"], {
    isSize: 3
  }, AppContainer_jsx(Sidebar, null)), children)));
}
...
function Master({
  ...
  return Master_jsx(external_react_default.a.Fragment, null, Master_jsx(head_default.a, null, Master_jsx("title", null, "Gym App"), Master_jsx("meta", {
    name: "viewport",
...
class _app_MyApp extends app_default.a {
  render() {
    ...
    if (router.pathname === '/login' || router.pathname === '/recuperar-senha') {
      return _app_jsx(Master, null, _app_jsx(Component, pageProps));
    }

    return _app_jsx(Master, null, _app_jsx(AppContainer, null, _app_jsx(Component, pageProps)));
  }
