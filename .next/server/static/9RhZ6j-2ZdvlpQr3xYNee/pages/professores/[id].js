...
module.exports = __webpack_require__("xZzs");
...
// CONCATENATED MODULE: ./components/PerfilProfessor/DetailsTab.js
...
function DetailsTab({
  ...
  return __jsx(external_bloomer_["Section"], null, __jsx(external_bloomer_["Columns"], {
    isMultiline: true
  }, __jsx(external_bloomer_["Column"], {
    isSize: "1/2"
  }, __jsx(external_bloomer_["Title"], {
    isSize: 6
  }, "E-mail"), __jsx(external_bloomer_["Subtitle"], {
    isSize: 6
  }, email)), __jsx(external_bloomer_["Column"], {
    isSize: "1/2"
  }, __jsx(external_bloomer_["Title"], {
    isSize: 6
  }, "Telefone"), __jsx(external_bloomer_["Subtitle"], {
    isSize: 6
  }, "(12) 12345-6789")), __jsx(external_bloomer_["Column"], {
    isSize: "1/2"
  }, __jsx(external_bloomer_["Title"], {
    isSize: 6
  }, "Cargo"), __jsx(external_bloomer_["Subtitle"], {
    isSize: 6
  }, level)), __jsx(external_bloomer_["Column"], {
    isSize: "1/2"
  }, __jsx(external_bloomer_["Title"], {
    isSize: 6
  }, "Especializa\xE7\xE3o"), __jsx(external_bloomer_["Subtitle"], {
    isSize: 6
  }, area)), __jsx(external_bloomer_["Column"], null, __jsx(external_bloomer_["Title"], {
    isSize: 6
  }, "Endere\xE7o"), __jsx(external_bloomer_["Subtitle"], {
    isSize: 6
  }, "Rua de Tal, n\xBA 123, Campos do Jord\xE3o - SP"))), __jsx(external_bloomer_["Columns"], null, __jsx(external_bloomer_["Column"], {
    hasTextAlign: "right"
  }, __jsx("div", {
    style: styles["a" /* default */].separator
  }), __jsx(external_bloomer_["Button"], {
    isColor: "primary"
  }, __jsx(external_bloomer_["Icon"], {
    isSize: "small",
    className: "fa fa-envelope"
  }), __jsx("span", null, "Enviar Mensagem")))));
}
// CONCATENATED MODULE: ./components/PerfilProfessor/AlunosTab.js

var AlunosTab_jsx = external_react_default.a.createElement;
function AlunosTab() {
  return AlunosTab_jsx("h1", null, "Lista de Alunos");
}
// CONCATENATED MODULE: ./components/PerfilProfessor/Perfil.js
...
function Perfil({
  ...
  return Perfil_jsx(external_bloomer_["Box"], null, Perfil_jsx(external_bloomer_["Tabs"], null, Perfil_jsx(external_bloomer_["TabList"], null, Perfil_jsx(external_bloomer_["Tab"], {
    onClick: () => setTab(true),
    isActive: tab
  }, Perfil_jsx(external_bloomer_["TabLink"], null, "Detalhes")), Perfil_jsx(external_bloomer_["Tab"], {
    onClick: () => setTab(false),
    isActive: !tab
  }, Perfil_jsx(external_bloomer_["TabLink"], null, "Alunos")))), tab ? Perfil_jsx(DetailsTab, {
    email: email,
    area: area,
    level: level.name
  }) : Perfil_jsx(AlunosTab, null));
}
// EXTERNAL MODULE: ./node_modules/@babel/runtime-corejs2/helpers/esm/objectSpread.js + 1 modules
var objectSpread = __webpack_require__("zrwo");

// CONCATENATED MODULE: ./components/PerfilProfessor/Main.js
...
function Main({
  ...
  return Main_jsx(external_bloomer_["Box"], {
    hasTextAlign: "centered"
  }, Main_jsx(external_bloomer_["Image"], {
    style: style,
    isSize: "128x128",
    src: photo
  }), Main_jsx(external_bloomer_["Title"], null, name), Main_jsx(external_bloomer_["Subtitle"], {
    isSize: 5
  }, area), Main_jsx(external_bloomer_["Tag"], {
    isColor: "dark",
    style: {
      backgroundColor: level.color
    }
  }, level.name), Main_jsx("div", {
    style: Object(objectSpread["a" /* default */])({}, styles["a" /* default */].levelBar, {
      backgroundColor: level.color
    })
  }));
}
// EXTERNAL MODULE: ./components/mockData.js
var mockData = __webpack_require__("FBHu");

// EXTERNAL MODULE: ./components/DropOptions.js + 1 modules
var DropOptions = __webpack_require__("0dL2");

// CONCATENATED MODULE: ./components/PerfilProfessor/index.js

var PerfilProfessor_jsx = external_react_default.a.createElement;
...
function PerfilAluno({
  ...
  const {
    ...
    level,
    photo
  } = mockData["a" /* data */].find(obj => obj.id.toString() === id);
  return PerfilProfessor_jsx(external_bloomer_["Column"], null, PerfilProfessor_jsx(external_bloomer_["Columns"], null, PerfilProfessor_jsx(external_bloomer_["Column"], null, PerfilProfessor_jsx(link_default.a, {
    href: "/professores"
  }, PerfilProfessor_jsx("a", null, PerfilProfessor_jsx(external_bloomer_["Icon"], {
    isSize: "large",
    className: "fa fa-arrow-left"
  }), "Voltar"))), PerfilProfessor_jsx(external_bloomer_["Column"], {
    hasTextAlign: "right"
  }, PerfilProfessor_jsx(DropOptions["a" /* default */], {
    buttonName: "Editar Professor"
  }))), PerfilProfessor_jsx(external_bloomer_["Columns"], null, PerfilProfessor_jsx(external_bloomer_["Column"], {
    isSize: 5
  }, PerfilProfessor_jsx(Main, {
    name: name,
    photo: photo,
    area: area,
    level: level
  })), PerfilProfessor_jsx(external_bloomer_["Column"], null, PerfilProfessor_jsx(Perfil, {
    email: email,
    area: area,
    level: level
  }))));
}
// CONCATENATED MODULE: ./pages/professores/[id].js
...
/* harmony default export */ var _id_ = __webpack_exports__["default"] = (Object(auth["c" /* withAuth */])(Professor));
