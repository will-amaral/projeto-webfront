...
module.exports = __webpack_require__("lFWE");
...
// CONCATENATED MODULE: ./components/Professores/CardItem.js
...
function CardItem({
  ...
  }, __jsx(external_bloomer_["Box"], null, __jsx(external_bloomer_["Media"], null, __jsx(external_bloomer_["MediaLeft"], null, __jsx(external_bloomer_["Image"], {
    isSize: "64x64",
    src: photo
  })), __jsx(external_bloomer_["MediaContent"], null, __jsx(external_bloomer_["Content"], null, __jsx("p", null, __jsx("strong", null, name), __jsx("br", null), area, __jsx("br", null), __jsx("strong", {
    style: {
      color: levelColor
    }
  }, __jsx("small", null, email)))))), __jsx("div", {
...
// CONCATENATED MODULE: ./components/Professores/Cards.js
...
function Cards() {
  const items = mockData["a" /* data */].map(item => Cards_jsx(CardItem, {
    name: item.name,
    area: item.area,
    email: item.email,
    photo: item.photo,
  ...
  return Cards_jsx(external_bloomer_["Columns"], {
    isMultiline: true
  }, items);
}
...
// CONCATENATED MODULE: ./components/Professores/AddProfessor.js

var AddProfessor_jsx = external_react_default.a.createElement;
...
function AddProfessor({
  ...
  return AddProfessor_jsx(ModalContainer["a" /* default */], {
    colored: true,
    active: active,
    close: close
  }, AddProfessor_jsx(Signup["a" /* default */], null));
}
// CONCATENATED MODULE: ./components/Professores/index.js

var Professores_jsx = external_react_default.a.createElement;
...
function Alunos() {
  ...
  return Professores_jsx(external_bloomer_["Column"], null, Professores_jsx(external_bloomer_["Columns"], null, Professores_jsx(external_bloomer_["Column"], {
    isSize: 8
  }, Professores_jsx(SimpleInput["a" /* default */], null)), Professores_jsx(external_bloomer_["Column"], {
    hasTextAlign: "right"
  }, Professores_jsx(external_bloomer_["Button"], {
    isColor: "primary",
    onClick: () => setModal(true)
  }, Professores_jsx(external_bloomer_["Icon"], {
    isSize: "small",
    className: "fas fa-plus"
  }), Professores_jsx("span", null, "Cadastrar Professor")))), Professores_jsx(Cards, null), Professores_jsx(AddProfessor, {
    active: modal,
    close: () => setModal(false)
  }));
}
// CONCATENATED MODULE: ./pages/professores/index.js
...
function Professores() {
  return professores_jsx(Alunos, null);
}

/* harmony default export */ var professores = __webpack_exports__["default"] = (Object(auth["c" /* withAuth */])(Professores));
