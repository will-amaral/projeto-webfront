...
/* harmony import */ var _Form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Form */ "./components/Login/Form.js");
...
function Login() {
  ...
  async function handleSubmit(event, email, password) {
    ...
    if (!email || !password) {
      ...
      try {
        ...
        } = await _utils_api__WEBPACK_IMPORTED_MODULE_5__["default"].post('/login', {
          email,
          password
        });
        Object(_utils_auth__WEBPACK_IMPORTED_MODULE_6__["login"])(token);
  ...
  return __jsx(bloomer__WEBPACK_IMPORTED_MODULE_1__["Columns"], {
    ...
    style: _styles__WEBPACK_IMPORTED_MODULE_7__["default"].logo,
    ...
    __self: this
  }, "Fa\xE7a o login para prosseguir"), __jsx(_CustomNotification__WEBPACK_IMPORTED_MODULE_3__["default"], {
    message: message,
    color: color,
    close: () => setMessage(''),
    __source: {
    ...
    isFullHeight: true,
    style: _styles__WEBPACK_IMPORTED_MODULE_7__["default"].background,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 58
    },
...
module.exports = __webpack_require__(/*! /home/will/Documents/School/projeto-ifsp/webfront/pages/login.js */"./pages/login.js");
