...
function PerfilAluno(_ref) {
  var id = _ref.id;
  var alunoData = _mockData__WEBPACK_IMPORTED_MODULE_5__["data"].find(function (obj) {
    return obj.id === id;
  });
  console.log(alunoData);
  console.log('Data id' + _mockData__WEBPACK_IMPORTED_MODULE_5__["data"][0].id);
...
//# sourceMappingURL=[id].js.0951d2464b9209b1cb76.hot-update.js.map