  ...
  function mapRoutes(route) {
    return route.map(function (_ref) {
      var key = _ref.key,
          path = _ref.path,
          name = _ref.name;
      isActive(path) ? __jsx(next_link__WEBPACK_IMPORTED_MODULE_3___default.a, {
        href: path,
        key: key,
        __source: {
        ...
        __self: this
      }, name)) : __jsx(next_link__WEBPACK_IMPORTED_MODULE_3___default.a, {
        href: path,
        key: key,
        __source: {
          fileName: _jsxFileName,
...
//# sourceMappingURL=_app.js.fa351418aa0f64f430a1.hot-update.js.map